(function(a){a.fn.qr=function(d){function f(d,f){for(var l=escape(d);-1!=l.indexOf("/");)l=l.replace("/","%2f");var w=document.createElement("div");$qr=a(w);$qr.css({background:"url('http://chart.apis.google.com/chart?cht=qr&chs="+f+"x"+f+"&chl="+l+"') no-repeat",width:f+"px",height:f+"px",display:"none","border-style":"solid","border-width":"1px",position:"absolute","z-index":"1000"});a("body").append($qr);return w}return this.each(function(){var k={size:"230",delay:"0"};d&&a.extend(k,d);var g=a(this);
...
"TAP":result;result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length));0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};"string"===typeof a&&d.load(a);"function"===typeof a&&(d.code=a,d.load());return d};(function(a,d){"function"===typeof define&&define.amd?define([],d):"undefined"!==typeof module&&module.exports?module.exports=d():a.ReconnectingWebSocket=d()})(this,function(){function a(d,f){function k(u){l=new WebSocket(d,f);g.onconnecting();(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","attempt-connect",d);var A=l,q=setTimeout(function(){(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","connection-timeout",d);t=!0;A.close();t=!1},g.timeoutInterval);l.onopen=function(f){clearTimeout(q);
(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","onopen",d);g.readyState=WebSocket.OPEN;u=!1;g.reconnectAttempts=0;g.onopen(f)};l.onclose=function(f){clearTimeout(q);l=null;w?(g.readyState=WebSocket.CLOSED,g.onclose(f)):(g.readyState=WebSocket.CONNECTING,g.onconnecting(),u||t||((g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","onclose",d),g.onclose(f)),setTimeout(function(){g.reconnectAttempts++;k(!0)},g.reconnectInterval*Math.pow(g.reconnectDecay,g.reconnectAttempts)))};
l.onmessage=function(f){(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","onmessage",d,f.data);g.onmessage(f)};l.onerror=function(f){(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","onerror",d,f);g.onerror(f)}}f=f||[];this.debug=!1;this.reconnectInterval=1E3;this.reconnectDecay=1.5;this.reconnectAttempts=0;this.timeoutInterval=2E3;var g=this,l,w=!1,t=!1;this.url=d;this.protocols=f;this.readyState=WebSocket.CONNECTING;this.URL=d;this.onopen=function(a){};this.onclose=function(a){};
this.onconnecting=function(a){};this.onmessage=function(a){};this.onerror=function(a){};k(!1);this.send=function(f){if(l)return(g.debug||a.debugAll)&&console.debug("ReconnectingWebSocket","send",d,f),l.send(f);throw"INVALID_STATE_ERR : Pausing to reconnect websocket";};this.close=function(){w=!0;l&&l.close()};this.refresh=function(){l&&l.close()}}a.debugAll=!1;return a});(function(a){function d(a){throw new RangeError("noUiSlider: "+a);}function f(a,e,b){(a[e]||a[b])&&a[e]===a[b]&&d("(Link) '"+e+"' can't match '"+b+"'.'")}function k(a){return Math.max(Math.min(a,100),0)}function g(a){return"number"===typeof a&&!isNaN(a)&&isFinite(a)}function l(e){return a.isArray(e)?e:[e]}function w(a,e,b){a.addClass(e);setTimeout(function(){a.removeClass(e)},b)}function t(a,e){return 100*e/(a[1]-a[0])}function u(a,e){if(e>=a.xVal.slice(-1)[0])return 100;for(var b=1,c,d,h;e>=a.xVal[b];)b++;
c=a.xVal[b-1];d=a.xVal[b];h=a.xPct[b-1];b=a.xPct[b];c=[c,d];c=t(c,0>c[0]?e+Math.abs(c[0]):e-c[0]);return h+c/(100/(b-h))}function A(a,e){for(var b=1,c;e>=a.xPct[b];)b++;if(a.snap)return c=a.xPct[b-1],b=a.xPct[b],e-c>(b-c)/2?b:c;if(!a.xSteps[b-1])return e;c=a.xPct[b-1];var d=a.xSteps[b-1],b=Math.round((e-a.xPct[b-1])/d)*d;return c+b}function q(e){void 0===e&&(e={});"object"!==typeof e&&d("(Format) 'format' option must be an object.");var b={};a(N).each(function(a,c){void 0===e[c]?b[c]=G[a]:typeof e[c]===
typeof G[a]?("decimals"===c&&(0>e[c]||7<e[c])&&d("(Format) 'format.decimals' option must be between 0 and 7."),b[c]=e[c]):d("(Format) 'format."+c+"' must be a "+typeof G[a]+".")});f(b,"mark","thousand");f(b,"prefix","negative");f(b,"prefix","negativeBefore");this.settings=b}function n(e,b){if(!(this instanceof n))throw Error("Link: Don't use Link as a function. Use the 'new' keyword.");if(!e)throw new RangeError("Link: missing parameters.");this.formatting=e.format||{};this.update=!b;var c=this,d=
e.target||function(){},h=e.method,f="string"===typeof d&&0===d.indexOf("-tooltip-"),g="string"===typeof d&&0!==d.indexOf("-"),D="function"===typeof d,m=d instanceof a||a.zepto&&a.zepto.isZ(d),k=m&&d.is("input, select, textarea"),p=m&&"function"===typeof h,l=m&&"string"===typeof h&&d[h];if(f)this.method=h||"html",this.el=a(d.replace("-tooltip-","")||"<div/>")[0];else if(g)this.method="val",this.el=document.createElement("input"),this.el.name=d,this.el.type="hidden";else if(D)this.target=!1,this.method=
d;else{if(m){if(h&&(p||l)){this.target=d;this.method=h;return}if(!h&&k){this.method="val";this.target=d;this.target.on("change",function(e){e=a(e.target).val();var b=c.N;c.obj.val([b?null:e,b?e:null],{link:c})});return}if(!h&&!k){this.method="html";this.target=d;return}}throw new RangeError("Link: Invalid Link.");}}function H(a,e){g(e)||d("'step' is not numeric.");a.xSteps[0]=e}function E(e,b){("object"!==typeof b||a.isArray(b))&&d("'range' is not an object.");a.each(b,function(b,c){var B;"number"===
typeof c&&(c=[c]);a.isArray(c)||d("'range' contains invalid value.");B="min"===b?0:"max"===b?100:parseFloat(b);g(B)&&g(c[0])||d("'range' value isn't numeric.");e.xPct.push(B);e.xVal.push(c[0]);B?e.xSteps.push(isNaN(c[1])?!1:c[1]):isNaN(c[1])||(e.xSteps[0]=c[1])});a.each(e.xSteps,function(a,b){if(!b)return!0;e.xSteps[a]=t([e.xVal[a],e.xVal[a+1]],b)/(100/(e.xPct[a+1]-e.xPct[a]))})}function F(e,b){"number"===typeof b&&(b=[b]);(!a.isArray(b)||!b.length||2<b.length)&&d("'start' option is incorrect.");
e.handles=b.length;e.start=b}function I(a,e){a.snap=e;"boolean"!==typeof e&&d("'snap' option must be a boolean.")}function e(a,e){"lower"===e&&1===a.handles?a.connect=1:"upper"===e&&1===a.handles?a.connect=2:!0===e&&2===a.handles?a.connect=3:!1===e?a.connect=0:d("'connect' option was doesn't match handle count.")}function b(a,e){switch(e){case "horizontal":a.ort=0;break;case "vertical":a.ort=1;break;default:d("'orientation' option is invalid.")}}function c(a,e){2<a.xPct.length&&d("'margin' option is only supported on linear sliders.");
a.margin=t(a.xVal,e);g(e)||d("'margin' option must be numeric.")}function h(a,e){switch(e){case "ltr":a.dir=0;break;case "rtl":a.dir=1;a.connect=[0,2,1,3][a.connect];break;default:d("'direction' option was not recognized.")}}function D(a,e){"string"!==typeof e&&d("'behaviour' must be a string containing options.");var b=0<=e.indexOf("tap"),c=0<=e.indexOf("extend"),h=0<=e.indexOf("drag"),f=0<=e.indexOf("fixed"),g=0<=e.indexOf("snap");a.events={tap:b||g,extend:c,drag:h,fixed:f,snap:g}}function m(e,
b,c){e.ser=[b.lower,b.upper];e.formatting=new q(b.format);a.each(e.ser,function(e,h){a.isArray(h)||d("'serialization."+(e?"upper":"lower")+"' must be an array.");a.each(h,function(){this instanceof n||d("'serialization."+(e?"upper":"lower")+"' can only contain Link instances.");this.N=e;this.obj=c;this.scope=this.scope||c;this.formatting=new q(a.extend({},b.format,this.formatting))})});e.dir&&1<e.handles&&e.ser.reverse()}function J(r,B){var f={xPct:[],xVal:[],xSteps:[!1],margin:0},g;g={step:{r:!1,
t:H},range:{r:!0,t:E},start:{r:!0,t:F},snap:{r:!1,t:I},connect:{r:!0,t:e},orientation:{r:!1,t:b},margin:{r:!1,t:c},direction:{r:!0,t:h},behaviour:{r:!0,t:D},serialization:{r:!0,t:m}};r=a.extend({connect:!1,direction:"ltr",behaviour:"tap",orientation:"horizontal"},r);r.serialization=a.extend({lower:[],upper:[],format:{}},r.serialization);a.each(g,function(a,e){if(void 0===r[a])if(e.r)d("'"+a+"' is required.");else return!0;e.t(f,r[a],B)});f.style=f.ort?"top":"left";return f}function K(e,b){var c=a("<div><div/></div>").addClass(p[2]),
d=["-lower","-upper"];e.dir&&d.reverse();c.children().addClass(p[3]+" "+p[3]+d[b]);return c}function z(e,b){b.el&&(b=new n({target:a(b.el).clone().appendTo(e),method:b.method,format:b.formatting},!0));return b}function O(a,e){var b,c=[];for(b=0;b<a.handles;b++){var d=b,h=a.ser[b],f=e[b].children(),g=void 0,m=[];m.push(new n({format:a.formatting},!0));for(g=0;g<h.length;g++)m.push(z(f,h[g]));c[d]=m}return c}function P(a,e,b){switch(a){case 1:e.addClass(p[7]);b[0].addClass(p[6]);break;case 3:b[1].addClass(p[6]);
case 2:b[0].addClass(p[7]);case 0:e.addClass(p[6])}}function Q(a,e){var b,c=[];for(b=0;b<a.handles;b++)c.push(K(a,b).appendTo(e));return c}function R(e,b){b.addClass([p[0],p[8+e.dir],p[4+e.ort]].join(" "));return a("<div/>").appendTo(b).addClass(p[1])}function S(e,b,c){function d(){return t[["width","height"][b.ort]]()}function h(a){var e,b=[v.val()];for(e=0;e<a.length;e++)v.trigger(a[e],b)}function f(e,c,d){var h=e[0]!==s[0][0]?1:0,g=n[0]+b.margin,r=n[1]-b.margin;d&&1<s.length&&(c=h?Math.max(c,g):
Math.min(c,r));100>c&&(c=A(b,c));c=k(parseFloat(c.toFixed(7)));if(c===n[h])return 1===s.length?!1:c===g||c===r?0:!1;e.css(b.style,c+"%");e.is(":first-child")&&e.toggleClass(p[17],50<c);n[h]=c;b.dir&&(c=100-c);a(z[h]).each(function(){this.write(b,c,e.children(),v)});return!0}function g(a,e,b){b||w(v,p[14],300);f(a,e,!1);h(["slide","set","change"])}function m(a,e,c,d){a=a.replace(/\s/g,".nui ")+".nui";return e.on(a,function(a){var e=v.attr("disabled"),e=!(void 0===e||null===e);if(v.hasClass(p[14])||
...
h;a=m;a.calcPoint=a.points[b.ort];c(a,d)})}function D(a,e){var b=e.handles||s,c,g=!1,g=100*(a.calcPoint-e.start)/d(),r=b[0][0]!==s[0][0]?1:0;var m=e.positions;c=g+m[0];g+=m[1];1<b.length?(0>c&&(g+=Math.abs(c)),100<g&&(c-=g-100),c=[k(c),k(g)]):c=[c,g];g=f(b[0],c[r],1===b.length);1<b.length&&(g=f(b[1],c[r?0:1],!1)||g);g&&h(["slide"])}function l(e){a("."+p[15]).removeClass(p[15]);e.cursor&&a("body").css("cursor","").off(".nui");L.off(".nui");v.removeClass(p[12]);h(["set","change"])}function q(e,b){1===
b.handles.length&&b.handles[0].children().addClass(p[15]);e.stopPropagation();m(C.move,L,D,{start:e.calcPoint,handles:b.handles,positions:[n[0],n[s.length-1]]});m(C.end,L,l,null);e.cursor&&(a("body").css("cursor",a(e.target).css("cursor")),1<s.length&&v.addClass(p[12]),a("body").on("selectstart.nui",!1))}function K(e){var c=e.calcPoint,h=0;e.stopPropagation();a.each(s,function(){h+=this.offset()[b.style]});h=c<h/2||1===s.length?0:1;c-=t.offset()[b.style];c=100*c/d();g(s[h],c,b.events.snap);b.events.snap&&
q(e,{handles:[s[h]]})}function J(a){var e=(a=a.calcPoint<t.offset()[b.style])?0:100;a=a?0:s.length-1;g(s[a],e,!1)}var v=a(e),n=[-1,-1],t,z,s;if(!v.is(":empty"))throw Error("Slider was already initialized.");t=R(b,v);s=Q(b,t);z=O(b,s);P(b.connect,v,s);(function(a){var e;if(!a.fixed)for(e=0;e<s.length;e++)m(C.start,s[e].children(),q,{handles:[s[e]]});a.tap&&m(C.start,t,K,{handles:s});a.extend&&(v.addClass(p[16]),a.tap&&m(C.start,v,J,{handles:s}));a.drag&&(e=t.find("."+p[7]).addClass(p[10]),a.fixed&&
(e=e.add(t.children().not(e).children())),m(C.start,e,q,{handles:s}))})(b.events);e.vSet=function(e,c,d,g,r){var m;b.dir&&1<b.handles&&e.reverse();r&&w(v,p[14],300);for(m=0;m<(1<s.length?3:1);m++)r=d||z[m%2][0],r=r.valueOf(e[m%2]),!1!==r&&(r=u(b,r),b.dir&&(r=100-r),!0!==f(s[m%2],r,!0)&&a(z[m%2]).each(function(){this.write(b,n[m%2],s[m%2].children(),v,g)}));!0===c&&h(["set"]);return this};e.vGet=function(){var a,e=[];for(a=0;a<b.handles;a++)e[a]=z[a][0].saved;return 1===e.length?e[0]:b.dir&&1<b.handles?
e.reverse():e};e.destroy=function(){a.each(z,function(){a.each(this,function(){this.target&&this.target.off(".nui")})});a(this).off(".nui").removeClass(p.join(" ")).empty();return c};v.val(b.start)}function T(a){this.length||d("Can't initialize slider on empty selection.");var e=J(a,this);return this.each(function(){S(this,e,a)})}function U(e){return this.each(function(){var b=a(this).val(),c=this.destroy(),d=a.extend({},c,e);a(this).noUiSlider(d);c.start===d.start&&a(this).val(b)})}var L=a(document),
M=a.fn.val,C=window.navigator.pointerEnabled?{start:"pointerdown",move:"pointermove",end:"pointerup"}:window.navigator.msPointerEnabled?{start:"MSPointerDown",move:"MSPointerMove",end:"MSPointerUp"}:{start:"mousedown touchstart",move:"mousemove touchmove",end:"mouseup touchend"},p="noUi-target noUi-base noUi-origin noUi-handle noUi-horizontal noUi-vertical noUi-background noUi-connect noUi-ltr noUi-rtl noUi-dragable  noUi-state-drag  noUi-state-tap noUi-active noUi-extended noUi-stacking".split(" "),
N="decimals mark thousand prefix postfix encoder decoder negative negativeBefore".split(" "),G=[2,".","","","",function(a){return a},function(a){return a},"-",""];q.prototype.v=function(a){return this.settings[a]};q.prototype.to=function(a){function e(a){return a.split("").reverse().join("")}a=this.v("encoder")(a);var b="",c="",d="",h="";0>a&&(b=this.v("negative"),c=this.v("negativeBefore"));a=Math.abs(a).toFixed(this.v("decimals")).toString();a=a.split(".");0===parseFloat(a)&&(a[0]="0");this.v("thousand")?
...
c[0],e,b,c);else this.target[this.method](e,b,c)}};n.prototype.format=function(a){return this.formatting.to(a)};n.prototype.valueOf=function(a){return this.formatting.from(a)};a.noUiSlider={Link:n};a.fn.noUiSlider=function(a,e){return(e?U:T).call(this,a)};a.fn.val=function(){var e=Array.prototype.slice.call(arguments,0),b,c,d,h;if(!e.length)return this.hasClass(p[0])?this[0].vGet():M.apply(this);"object"===typeof e[1]?(b=e[1].set,c=e[1].link,d=e[1].update,h=e[1].animate):!0===e[1]&&(b=!0);return this.each(function(){a(this).hasClass(p[0])?
this.vSet(l(e[0]),b,c,d,h):M.apply(a(this),e)})}})(window.jQuery||window.Zepto);(function(){var a={},d=null,f=!0,k=!1;try{"undefined"!==typeof AudioContext?d=new AudioContext:"undefined"!==typeof webkitAudioContext?d=new webkitAudioContext:f=!1}catch(g){f=!1}if(!f)if("undefined"!==typeof Audio)try{new Audio}catch(l){k=!0}else k=!0;if(f){var w="undefined"===typeof d.createGain?d.createGainNode():d.createGain();w.gain.value=1;w.connect(d.destination)}var t=function(a){this._volume=1;this._muted=!1;this.usingWebAudio=f;this.ctx=d;this.noAudio=k;this._howls=[];this._codecs=a;this.iOSAutoEnable=
!0};t.prototype={volume:function(a){a=parseFloat(a);if(0<=a&&1>=a){this._volume=a;f&&(w.gain.value=a);for(var b in this._howls)if(this._howls.hasOwnProperty(b)&&!1===this._howls[b]._webAudio)for(a=0;a<this._howls[b]._audioNode.length;a++)this._howls[b]._audioNode[a].volume=this._howls[b]._volume*this._volume;return this}return f?w.gain.value:this._volume},mute:function(){this._setMuted(!0);return this},unmute:function(){this._setMuted(!1);return this},_setMuted:function(a){this._muted=a;f&&(w.gain.value=
...
h.noteOn(0):h.start(0);setTimeout(function(){if(h.playbackState===h.PLAYING_STATE||h.playbackState===h.FINISHED_STATE)a._iOSEnabled=!0,a.iOSAutoEnable=!1,window.removeEventListener("touchstart",b,!1)},0)};window.addEventListener("touchstart",b,!1);return a}}};var u=null,A={};k||(u=new Audio,A={mp3:!!u.canPlayType("audio/mpeg;").replace(/^no$/,""),opus:!!u.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/,""),ogg:!!u.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,""),wav:!!u.canPlayType('audio/wav; codecs="1"').replace(/^no$/,
""),aac:!!u.canPlayType("audio/aac;").replace(/^no$/,""),m4a:!!(u.canPlayType("audio/x-m4a;")||u.canPlayType("audio/m4a;")||u.canPlayType("audio/aac;")).replace(/^no$/,""),mp4:!!(u.canPlayType("audio/x-mp4;")||u.canPlayType("audio/mp4;")||u.canPlayType("audio/aac;")).replace(/^no$/,""),weba:!!u.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/,"")});var q=new t(A),n=function(a){this._autoplay=a.autoplay||!1;this._buffer=a.buffer||!1;this._duration=a.duration||0;this._format=a.format||null;
...
d&&q._howls.splice(d,1);delete a[this._src]}};if(f)var H=function(d,b){if(b in a)d._duration=a[b].duration,F(d);else if(/^data:[^;]+;base64,/.test(b)){for(var c=atob(b.split(",")[1]),f=new Uint8Array(c.length),g=0;g<c.length;++g)f[g]=c.charCodeAt(g);E(f.buffer,d,b)}else{var k=new XMLHttpRequest;k.open("GET",b,!0);k.responseType="arraybuffer";k.onload=function(){E(k.response,d,b)};k.onerror=function(){d._webAudio&&(d._buffer=!0,d._webAudio=!1,d._audioNode=[],delete d._gainNode,delete a[b],d.load())};
try{k.send()}catch(l){k.onerror()}}},E=function(e,b,c){d.decodeAudioData(e,function(d){d&&(a[c]=d,F(b,d))},function(a){b.on("loaderror")})},F=function(a,b){a._duration=b?b.duration:a._duration;0===Object.getOwnPropertyNames(a._sprite).length&&(a._sprite={_default:[0,1E3*a._duration]});a._loaded||(a._loaded=!0,a.on("load"));a._autoplay&&a.play()},I=function(e,b,c){c=e._nodeById(c);c.bufferSource=d.createBufferSource();c.bufferSource.buffer=a[e._src];c.bufferSource.connect(c.panner);c.bufferSource.loop=
...
TransactionSocket.init=function(){TransactionSocket.connection&&TransactionSocket.connection.close();if("WebSocket"in window){var a=new ReconnectingWebSocket("ws://ws.blockchain.info:8335/inv");TransactionSocket.connection=a;StatusBox.reconnecting("blockchain");a.onopen=function(){console.log("Blockchain.info: Connection open!");StatusBox.connected("blockchain");a.send(JSON.stringify({op:"unconfirmed_sub"}));a.send(JSON.stringify({op:"blocks_sub"}));a.send(JSON.stringify({op:"ping_tx"}))};a.onclose=
function(){console.log("Blockchain.info: Connection closed");$("#blockchainCheckBox").prop("checked")?StatusBox.reconnecting("blockchain"):StatusBox.closed("blockchain")};a.onerror=function(a){console.log("Blockchain.info: Connection Error: "+a)};a.onmessage=function(a){a=JSON.parse(a.data);if("utx"==a.op){for(var f=0,k=0;k<a.x.out.length;k++)f+=a.x.out[k].value;for(var g=f/satoshi,f=a.x.out,k=0;k<f.length;k++)if(f[k].addr==DONATION_ADDRESS||f[k].addr==SOUND_DONATION_ADDRESS){g=a.x.out[k].value/satoshi;
new Transaction(g,!0);return}setTimeout(function(){new Transaction(g)},Math.random()*DELAY_CAP)}else if("block"==a.op){var f=a.x.height,k=a.x.nTx,l=a.x.estimatedBTCSent;a=a.x.size;f>lastBlockHeight&&(lastBlockHeight=f,console.log("New Block"),new Block(f,k,l,a))}}}else console.log("No websocket support."),StatusBox.nosupport("blockchain")};TransactionSocket.close=function(){TransactionSocket.connection&&TransactionSocket.connection.close();StatusBox.closed("blockchain")};function TradeSocket(){}
...
Floatable.prototype.update=function(a){this.x+=this.velocity.x;this.y+=this.velocity.y*a/TICK_SPEED;this.velocity.x+=.1*Math.random()-.05;2<this.velocity.x&&(this.velocity.x=2);-2>this.velocity.x&&(this.velocity.x=-2);0>this.x&&(this.velocity.x+=.02);this.x>this.pageDivWidth-this.width&&(this.velocity.x-=.02);this.updateDiv();this.y<-this.height&&this.removeSelf()};Floatable.prototype.updateDiv=function(){this.div.style.top=this.y+"px";this.div.style.left=this.x+"px"};
Floatable.prototype.removeSelf=function(){this.pageDiv.removeChild(this.div);updateTargets.splice(updateTargets.indexOf(this),1)};Floatable.prototype.addImage=function(a,d,f){this.canvas=document.createElement("canvas");this.image=a;this.canvas.height=f;this.canvas.width=d;this.canvas.style.position="absolute";this.canvas.style.top="0px";this.canvas.style.left="0px";this.canvas.getContext("2d").drawImage(this.image,0,0,d-1,f-1);this.div.appendChild(this.canvas)};
...
transform:"scaleX(-1)"});-.1>a.velocity.x&&$(a.div).css({"-moz-transform":"scaleX(1)","-o-transform":"scaleX(1)","-webkit-transform":"scaleX(1)",transform:"scaleX(1)"})}};new Konami(easterSuccess);function Block(a,d,f,k){Floatable.call(this);f=Math.floor(f/satoshi)+" BTC";k=Math.floor(k/1024)+" KB";this.width=this.height=500;this.addImage(blockImage,this.width,this.height);this.addText("Block #"+a+"<br />Number of Transactions: "+d+"<br />Transaction Volume: "+f+"<br />Block Size: "+k);this.initPosition();Sound.playRandomSwell()}extend(Floatable,Block);function Transaction(a,d,f,k){Floatable.call(this);this.area=100*a+3E3;this.width=this.height=2*Math.sqrt(this.area/Math.PI);this.addImage(bubbleImage,this.width,this.height);var g="&#3647;"+a.toFixed(2);"&#3647;0.00"==g&&(g="<&#3647;0.01");d?this.addText('<span style="color: yellow;">'+g+'</span><br /><span style="color: cyan;">Donation</span><br /><span style="color: lime;">Thanks!</span>'):this.addText(g);f&&k&&this.addText("<br />"+f.toFixed(2)+" "+k);this.initPosition();d=a/(1E3/(.7-.3))+.3;
.7<d&&(d=.7);a=Math.min(100,Math.log(a+1.0715307808111487)/Math.log(1.0715307808111487));globalScalePitch?Sound.playPitchAtVolume(d,100-a):Sound.playRandomAtVolume(d)}extend(Floatable,Transaction);var DEBUG_MODE=!1,DONATION_ADDRESS,SOUND_DONATION_ADDRESS,globalMute=!1,instanceId=0,pageDivId="pageDiv",TICK_SPEED=50,last_update=0,updateTargets=[],bubbleImage=new Image;bubbleImage.src="images/bubble.png";var blockImage=new Image;blockImage.src="images/block.png";var debugSpawner,updateLayoutWidth=function(){$(".chartMask").css("visibility","visible")},updateLayoutHeight=function(){var a=window.innerHeight;"none"!=$("#header").css("display")&&(a-=$("#header").outerHeight());$("#pageSplitter").height(a)};
...
var toggleInterface=function(){0===$(".interface:hidden").length?($(".interface").fadeOut(500,updateLayoutHeight),$("#hideInterface").html("[ Show Interface ]"),$("#hideInterface").css("opacity","0.5")):($(".interface").fadeIn(500),$("#hideInterface").html("[ Hide Interface ]"),$("#hideInterface").css("opacity","1"),updateLayoutHeight())},globalUpdate=function(){var a=(new Date).getTime(),d=a-last_update;last_update=a;for(a=0;a<updateTargets.length;a++)updateTargets[a].update(d);setTimeout(globalUpdate,
TICK_SPEED)};$(window).bind("load",function(){DEBUG_MODE?setInterval(debugSpawner,100):($("#blockchainCheckBox").prop("checked")&&TransactionSocket.init(),$("#mtgoxCheckBox").prop("checked")&&TradeSocket.init());globalUpdate();Sound.loadup();Sound.init()});
